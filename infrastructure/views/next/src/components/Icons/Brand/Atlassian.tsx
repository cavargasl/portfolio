export function BrandAtlassian(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg aria-hidden='true' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' fill='currentColor' {...props}>

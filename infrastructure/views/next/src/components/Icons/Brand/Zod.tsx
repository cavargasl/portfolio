export function BrandZod(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg aria-hidden='true' fill='currentColor' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' {...props}>
